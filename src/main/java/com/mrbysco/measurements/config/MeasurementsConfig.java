...
public class MeasurementsConfig {
	...
	public static class Common {
		...
		public final ConfigValue<String> textColor;
		...
		Common(ForgeConfigSpec.Builder builder) {
			...
			textColor = builder
				.comment("Set text color. [default: YELLOW] [Valid Options: RANDOM, XYZRGB or any valid DyeColor]")
			...
			lineWidthMax = builder
				.comment("Set max line width (thickness). [default(float): 2, min:0, max:16]")
